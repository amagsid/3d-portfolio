    ...
    return (
        <>
            ...
            <spotLight
                ...
                intensity={1}
            />
            <mesh ref={targetRef} position={[-10, -20, 5]} />{' '}
            {/* Light target */}
            <ambientLight target={targetRef.current} intensity={1} />
...
export function Material() {
    // const gradientTexture = new THREE.TextureLoader().load('gradient.png'); // Replace with the path to your gradient image
